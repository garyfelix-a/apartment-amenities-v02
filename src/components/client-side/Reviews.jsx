    ...
    <>
      ...
      <section className="p-[10px] mx-20 mt-4 flex items-start justify-center border-[#80808053] h-[80vh]">
        ...
        <section className="section-left w-[30vw] mr-4 h-[70vh]">
          ...
          <div className="p-2 text-white flex-col items-center justify-center bg-[#808080bb]">
            {/* <p>Overall Ratings</p> */}
            <button
          ...
          <div className="px-2 pt-3 mt-4 py-2 bg-[gray]">
            <div className="mb-4 py-2 flex justify-between items-center px-2 bg-white rounded-[5px]">
